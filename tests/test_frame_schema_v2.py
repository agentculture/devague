...
def test_schema_version_bumped_exactly_once() -> None:
    ...
    # field; then issue #97 t1's v5, Frame.lapses / LapseRecord; then bvts t1's
    # v6, Frame.obligations / Obligation) moves this pin forward rather than
    # leaving a stale, now-false assertion.
